...
if __name__ == '__main__':
	...
	parse.add_argument('--name', '-n', type=str, default='celebDF_JYUNYI_50%_Meso')
	...
	parse.add_argument('--model_name', '-mn', type=str, default='celebDF_JYUNYI_50%_Meso.pkl')
	parse.add_argument('--continue_train', type=bool, default=False)
	parse.add_argument('--model_path', '-mp', type=str, default='/ssd6/Roy/XceptionNet-Deepfake-master/output/Meso4_copy_5/best.pkl')
	parse.add_argument('--workers', type=int, default='8')
	parse.add_argument('--file', type=str, default='celebDF_JYUNYI_50%_Meso.txt')
