...
# import sys
# sys.path.append('/ssd6/Roy/XceptionNet-Deepfake-master/')
from dataset.dataset_fast import FaceForensics
...
def detection( args):
    ...
    import sys
    sys.path.append('..')
    from LeGR_master_weihao.mesonet_copy import Meso4
    model = Meso4()
    # model = torch.load('/ssd6/Roy/LeGR_master_weihao/ckpt/mesonet_flops0.70_1_pruned.t7')
    # args.pretrained_weight_path = '/ssd6/Roy/XceptionNet-Deepfake-master/output/Meso4_copy/16_Meso4_copy.pkl'
    ...
    # print('predict:',preds_arr)
    # print('real value:',labs_arr)
...
# df.to_csv('./result_csv/celeb_meso_try.csv', index=False)
